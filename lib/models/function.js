...
var BlitlineFunction = module.exports = function() {
  ...
  this.addSave = function(image_identifier, s3Bucket, s3Key, quality) {
    /* S3Bucket and S3Key are optional, only for use if Blitline
    is pushing to your bucket and you have given Blitline permission
    to write to that bucket. Quality is optional and is for JPEG output only
    Defaults to current Blitline default of 75 */
    ...
    if (quality) save.quality = quality;
